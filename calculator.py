   ...
   if (calculator_type==1):
      ...
      if (operation == "+"): 
         ...
         if (num2!=0):
            ...
            print('the operation is undefined in basic calculator you should use the calculator in advanved mode!')
      ...
      if(operation=='+' or operation=='-' or operation=='*' or operation=='%' or operation=='/' or operation=='//' or operation=='^'):
         ...
         if (operation == "||"): 
            ...
            print('sin(',num,')', "=", math.sin(rad))
         elif(operation=='cos'):
            print('cos(',num,')', "=", math.cos(rad))
         elif(operation=='tan'):
            print('tan(',num,')', "=", math.sin(rad)/math.cos(rad))
         elif(operation=='cot'):
            print('cot(',num,')', "=", math.cos(rad)/math.sin(rad))
      else:
